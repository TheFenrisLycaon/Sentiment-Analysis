...
log("[ Processing ]\tMaking Directories")
...
log("[ Success ]\tTree Complete")
log("[ Processing ]\tInitializing Emotions")
...
log("[ Success ]\tIntialization Complete")
log("[ Processing ]\tReading Data")
